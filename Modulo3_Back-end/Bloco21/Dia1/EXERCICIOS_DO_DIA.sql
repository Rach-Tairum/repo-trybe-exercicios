...
SELECT DEPARTMENT_ID, AVG(SALARY), COUNT(EMPLOYEE_ID) AS N FROM hr.employees GROUP BY DEPARTMENT_ID HAVING N > 10;
...
SELECT LAST_NAME, DATE(HIRE_DATE) FROM hr.employees WHERE MONTH(HIRE_DATE) = 7 AND YEAR(HIRE_DATE) = 1987;
